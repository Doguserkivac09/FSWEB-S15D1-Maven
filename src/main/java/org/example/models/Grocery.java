...
public void startGrocery(){
   int choice;
   do{
       System.out.println("Yapılmak istenen operasyonu seçiniz (0=çıkış , 1= Eklemek istediğiniz eleman , 2= çıkarmak istediğiniz eleman");
       choice = scanner.nextInt();
       scanner.nextLine();
       switch (choice){
           case 1:
               System.out.println("Eklenmesini istediğiniz elemanı girin");
               String itemsToAdd = scanner.nextLine();
               addItems(itemsToAdd);
               printSorted();
               break;
               case 2:
                   System.out.println("çıkarılmasını istediğiniz elemanı girin");
